    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toastpackage com.example.alumnimanager;
...
import java.util.ArrayList;
                    ...
                    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        btnComment.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent i = new Intent(getApplicationContext(), com.example.alumnimanager.CommentsActivity.class);
                ...
                }.makeText(getApplicationContext(), "Comment Added", Toast.LENGTH_SHORT).show();
